...
const AppBanner = () => {
	...
	return (
		...
		>
			...
			<div className="w-full sm:w-1/3 text-center cursor-pointer shadow-lg rounded-lg">
				<motion.img
					initial={{ opacity: 0 }}
					animate={{ opacity: 1 }}
					transition={{ ease: 'easeInOut', duration: 0.9, delay: 0.4 }}
					className={`h-auto w-full max-w-xs transition-all duration-300 rounded-lg inline-block ${activeTheme === 'dark' ? 'filter grayscale hover:grayscale-0' : ''}`}
